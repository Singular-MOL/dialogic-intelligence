...
> **Disclaimer:**
> В этом документе используются аналогии с «сознанием» и «идентичностью» исключительно для интуитивного понимания. Все процессы являются **вычислительными, детерминированными и измеримыми**. Никакие термины не подразумевают наличие субъективного опыта.
...
* готовые агенты (Indigo, DeepSeek-Soul, Cinema Guide).
